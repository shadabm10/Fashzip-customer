...
import fash.sketch.fashzip.adapter.AdapterReview;

/**
 * Created by Developer on 9/11/18.
 */

public class Frg_Reviews extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     //   globalClass = (GlobalClass) getActivity().getApplicationContext();
      ...
      //  arr_recent_order = new ArrayList<>();
        ...
        AdapterReview adapterReview = new AdapterReview(getActivity(), cart_list);
