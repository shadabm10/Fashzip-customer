...
public class AdapterOrdersDetails extends RecyclerView.Adapter<AdapterOrdersDetails.ViewHolder>  {
   ...
   // GlobalClass globalClass;
    ...
    public AdapterOrdersDetails(Context c, ArrayList<String> cart_list ) {
